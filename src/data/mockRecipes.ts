...
export const mockRecipes: Recipe[] = [
  ...
  },
  {
    ...
    imageUrl: "https://images.unsplash.com/photo-1599785209707-a456fc1337bb?q=80&w=2500&auto=format&fit=crop",
    ingredients: [
  ...
  },
  {
    ...
    description: "A healthy and flavorful meal featuring perfectly grilled salmon served over a bed of fluffy quinoa.",
    imageUrl: "https://images.unsplash.com/photo-1519622197734-451f5c3c1d1d?q=80&w=2500&auto=format&fit=crop",
    ingredients: [
      { name: "Salmon Fillet", quantity: "2 pieces (200g each)" },
    ...
    instructions: [
      "Cook the quinoa according to package directions. Fluff with a fork and let it cool slightly. Mix in the diced cucumber.",
      "Preheat a grill or grill pan to medium-high heat.",
      "Rub the salmon fillets with olive oil, and season with salt, pepper, and chopped dill.",
      "Grill the salmon for 4-6 minutes per side, or until cooked through.",
      "Serve the grilled salmon over the quinoa.",
  ...
  },
  {
    ...
    imageUrl: "https://images.unsplash.com/photo-1551538855-4f3c86a24ac4?q=80&w=2500&auto=format&fit=crop",
    ingredients: [
